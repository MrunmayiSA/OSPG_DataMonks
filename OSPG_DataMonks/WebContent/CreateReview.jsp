...
<h3>Write a review</h3>
	...
	<table border="1">
		<tr>
			...
			<td><input id="Review" name="Review" value=""></td>
		</tr>
		<tr>
		    <td><label for="Rating">Rating</label></td>
			<td><input id="Rating" name="Rating" value=""></td>
		</tr>
		<tr>
		    <td><label for="User_id">User ID</label></td>
			<td><input id="User_id" name="User_id" value="${fn:escapeXml(param.User_id)}"></td>
		</tr>
		<tr>
		    <td><label for="Property_id">Property ID</label></td>
			<td><input id="Property_id" name="Property_id" value="${fn:escapeXml(param.Property_id)}"></td>
		</tr>
		<tr>
